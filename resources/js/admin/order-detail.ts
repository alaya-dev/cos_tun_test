...
type Detail = { order: Order; is_editable: boolean; allowed_transitions: string[] };
...
const OrderDetailView: Component = {
    ...
    setup() {
        ...
        return {
            detail, lines, customer, note, loading, saving, money, variantLabel, statusMeta, transitionMeta, print: () => window.print(), copyReference,
